...
public class AuthController {
	...
	// ==========================
	// LINK CLICADO NO E-MAIL DE VERIFICAÇÃO (abre direto no navegador)
	// ==========================
	...
	// ==========================
	// REENVIA O LINK DE VERIFICAÇÃO (link expirado ou perdido)
	// ==========================

	@PostMapping("/resend-verification")
	public ResponseEntity<String> resendVerification(@RequestParam String email) {
		authService.resendVerification(email);
		return ResponseEntity.ok("Link de verificação reenviado. Confira sua caixa de entrada.");
	}

	// Página HTML simples exibida ao clicar no link do e-mail
	private String paginaDeConfirmacao(String titulo, String mensagem) {
